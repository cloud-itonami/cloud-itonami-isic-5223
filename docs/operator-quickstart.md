# Operator Quickstart — Community Airport Operations and Ground Handling

Shortest path from clone to a verified local dry-run for **ISIC 5223** (`cloud-itonami-isic-5223`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5223.git
cd cloud-itonami-isic-5223
```
...
- Blueprint governor key: `airport-operations-governor`
- Likely source path: `src/**/airport-operations-governor.cljc`
